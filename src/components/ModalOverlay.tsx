import { Modal, SafeAreaView, TouchableWithoutFeedback, View } from 'react-native';
...
const ModalOverlay: React.FC<Props> = ({ children, modalVisible, setModalVisible, height }) => (
    <Modal visible={modalVisible} animationType="fade" transparent>
        <View style={{ backgroundColor: "rgba(0, 0, 0, 0.3)", flex: 1, justifyContent: "flex-end" }}>
            ...
            <View style={{ height: height || SCREEN_HEIGHT * 0.5, width: SCREEN_WIDTH, backgroundColor: colors.Surface_light }}>
                <SafeAreaView style={{ flex: 1 }}>
                    <ActionsheetHeader />
                    <View style={{ paddingHorizontal: SCREEN_WIDTH * 0.05, flex: 1 }}>
                        {children}
                    </View>
                </SafeAreaView>
            </View>
